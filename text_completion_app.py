...
try:
    ...
    log.warning("Failed to load model. Make sure you have access to the model and your connection is stable.\n")
    time.sleep(0.5)
except ValueError:
    log.warning("Incorrect model architecture or tokenizer class loaded.\n")
    time.sleep(0.5)
except Exception as e:
    log.warning("An error occurred. Could be memory or environment-related.\n")
    time.sleep(0.5)
else:
